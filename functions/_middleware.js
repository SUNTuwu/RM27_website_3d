...
async function handleLogin(context) {
  ...
  const expected = textEncoder.encode(context.env.SITE_PASSWORD)
  ...
  const matches = actualDigest.length === expectedDigest.length && actualDigest.every((byte, index) => byte === expectedDigest[index])
